...
4. **The audit and assurance layer.** Whether you can reconstruct what happened, whether your verification reflects production, and whether the indicators you read off that verification still stand for the properties they were chosen to represent. The defense is end-to-end logging, continuous evaluation, change management, a runtime posture that degrades capability under uncertainty, and — because every check is ultimately a stand-in — tests that fail when the stand-in and the property come apart.
