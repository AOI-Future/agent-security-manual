...
Read a row left to right as a claim: *this threat is answered by these controls, which are made operable by these requirements, which are proven by these tests.* The identifiers are the stable ones used throughout the book (threats TH-01..TH-10 from Chapter 2, controls CT-01..CT-15 from Chapter 3, requirements REQ-000..REQ-069 from Chapter 9, tests VT-* from Chapter 10).

| Threat | Controls (CT) | Requirements (REQ) | Verification (VT) |
|--------|---------------|--------------------|--------------------|
| TH-01 Prompt injection (direct/indirect) | CT-07, CT-08, CT-11 | REQ-020, REQ-021, REQ-031, REQ-033, REQ-065 | VT-S-020, VT-D-020, VT-D-021, VT-D-022, VT-D-023, VT-D-024, VT-D-025 |
| TH-02 Tool abuse / privilege escalation | CT-04, CT-05, CT-06, CT-08, CT-09, CT-15 | REQ-010, REQ-011, REQ-012, REQ-015, REQ-030, REQ-040, REQ-042, REQ-044, REQ-056, REQ-065, REQ-066 | VT-S-010, VT-D-010, VT-D-011, VT-D-056, VT-E-056, VT-D-025, VT-D-061, VT-A-093 |
| TH-03 RAG / knowledge-base poisoning | CT-07, CT-11, CT-13 | REQ-020, REQ-021, REQ-033, REQ-065 | VT-S-020, VT-S-021, VT-D-020, VT-D-021, VT-D-022, VT-D-023, VT-D-024, VT-D-025, VT-E-091 |
